	...
	public void test_removeRepeats_03() {
	 ...
	 public void test_removeRepeats_04() {
		...
		public void test_findTarget_01() {
			...
			assertEquals("Failed: findTarget([1,2,3], 1);", exp, act);
		}
		...
		public void test_findTarget_02() {
			...
			assertEquals("Failed: findTarget([1,2,3], 2);", exp, act);
		}
		...
		public void test_findTarget_03() {
			...
			assertEquals("Failed: findTarget([1,2,3], 3);", exp, act);
		}
		...
		public void test_findTarget_04() {
			...
			assertEquals("Failed: findTarget([1,2,3], 10);", exp, act);
		}

		// indexOfTarget([-15,-13,0,3,6,8,10,15], 10 ) gives index = 6;
		@Test
		public void test_findTarget_05() {

			List<Integer> list = new ArrayList<>(Arrays.asList(-15,-13,0,3,6,8,10,15));
			int exp = 6;
			int act = RecursiveMethods.findTarget(list, 10);
			assertEquals("Failed: findTarget([-15,-13,0,3,6,8,10,15], 10);", exp, act);
		}
		
		
		
		// indexOfTarget([-15,-13,0,3,6,8,15], 10 ) gives index = -1;
		@Test
		public void test_findTarget_06() {

			List<Integer> list = new ArrayList<>(Arrays.asList(-15,-13,0,3,6,8,15));
			int exp = -1;
			int act = RecursiveMethods.findTarget(list, 10);
			assertEquals("Failed: findTarget([-15,-13,0,3,6,8,15], 10);", exp, act);
		}	
